...
refmlLogan <- function(t_tac, reftac, roitac, k2prime, tstarIncludedFrames, weights, frameStartEnd) {
  ...
  fitvals <- data.frame(Time = t_tac, Reference = reftac, Weights = weights,
  ...
  out <- list( par = par, fit = fit, tacs = tacs, fitvals = fitvals, weights=weights, k2prime = k2prime, 
...
#'
#' @examples
#' plot_refmlLoganfit(refmlloganoutout)
#'
#' @author Granville J Matheson, \email{mathesong@@gmail.com}
#' 
#' @import ggplot2
...
#'
#' @examples
#' refmlLogan_tstar(t_tac, reftac, taclow, tacmed, tachigh, k2prime = k2prime, 'demonstration')
#'
#' @author Granville J Matheson, \email{mathesong@@gmail.com}
#' 
#' @import ggplot2
