...
refmlLogan <- function(t_tac, reftac, roitac, k2prime, tstar, weights = NULL,
...
refmlLogan_tstar <- function(t_tac, reftac, lowroi, medroi, highroi, k2prime, filename = NULL, frameStartEnd = NULL, timeStartEnd = NULL, gridbreaks = 2) {
  ...
  fitfunc <- function(roitac, tstar) {
    refmlLogan(t_tac, reftac, roitac, k2prime, tstar = tstar, frameStartEnd = frameStartEnd)
  }
  ...
  totalplot <- tstar_finalise_plot(
    ...
    outcome_ylim = NULL, filename = filename, modelname = "refmlLogan"
  )
