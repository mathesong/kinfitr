...
#' \describe{
#'   \item{PET}{Descriptor of which PET measurement}
#'   \item{Subjname}{Descriptor of which individual was measured}
#'   \item{PETNo}{Descriptor of which PET number}
...
#'   \item{Comment}{Descriptor of irregularities which may have occurred during measurement}
