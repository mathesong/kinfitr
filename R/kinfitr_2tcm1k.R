...
twotcm1k <- function(t_tac, tac, input, weights, inpshift, vB, frameStartEnd,
  ...
  Kb_pars = list(start = Kb.start , lower = Kb.lower , upper = Kb.upper)
  ...
  if(!missing(inpshift)) {
    ...
    output <- minpack.lm::nlsLM(tac ~ twotcm1k_model(t_tac, input, K1, k2, k3, k4, Kb, vB),
                                start = c(K1 = K1_pars$start, k2 = k2_pars$start, k3 = k3_pars$start, k4 = k4_pars$start, Kb = Kb_pars$start, vB = vB_pars$start),
                                lower = c(K1 = K1_pars$lower, k2 = k2_pars$lower, k3 = k3_pars$lower, k4 = k4_pars$lower, Kb = Kb_pars$lower, vB = vB_pars$lower),
                                upper = c(K1 = K1_pars$upper, k2 = k2_pars$upper, k3 = k3_pars$upper, k4 = k4_pars$upper, Kb = Kb_pars$upper, vB = vB_pars$upper),
  ...
  if(missing(inpshift)) {
    ...
    output <- minpack.lm::nlsLM(tac ~ twotcm1k_fitDelay_model(t_tac, input, K1, k2, k3, k4, Kb, inpshift, vB),
                                start = c(K1 = K1_pars$start, k2 = k2_pars$start, k3 = k3_pars$start, k4 = k4_pars$start, Kb = Kb_pars$start, inpshift = inpshift_pars$start, vB = vB_pars$start),
                                lower = c(K1 = K1_pars$lower, k2 = k2_pars$lower, k3 = k3_pars$lower, k4 = k4_pars$lower, Kb = Kb_pars$lower, inpshift = inpshift_pars$lower, vB = vB_pars$lower),
                                upper = c(K1 = K1_pars$upper, k2 = k2_pars$upper, k3 = k3_pars$upper, k4 = k4_pars$upper, Kb = Kb_pars$upper, inpshift = inpshift_pars$upper, vB = vB_pars$upper),
                                weights = weights, control = minpack.lm::nls.lm.control(maxiter = 200),
                                trace = printvals)
  }
