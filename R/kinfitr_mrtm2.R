...
mrtm2 <- function(t_tac, reftac, roitac, k2prime, tstarIncludedFrames, weights, frameStartEnd) {
  ...
  fitvals <- data.frame(Time = t_tac, Reference = reftac, Target = roitac, Weights = weights,
